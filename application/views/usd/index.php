...
<section class="header-amikom">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h3>Universitas Sanata Dharma</h3>
            ...
            <div class="col-lg" data-aos="fade-left" data-aos-easing="ease-in-sine">
                <img src="<?= base_url();?>assets/img/logo/usd-page.png" alt="niversitas Sanata Dharma" class="img-fluid gambar-header-amikom">
            </div>
        </div>
    </div>
</section>
<!-- Akhir Header -->
    ...
    <section class="info" data-aos="fade-right" data-aos-easing="ease-out-in">
        ...
        <h3>Info</h3>
            <div class="row">
                <div class="col">
                    <p>Jika tertarik dengan kampus Universitas Sanata Dharma, info lebih lanjut klik <a href="http://www.usd.ac.id" target="_blank">di sini</a>.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <center><div id='map'></div></center>
                    <script>
                        ...
                        var marker = new tt.Marker().setLngLat(usd).addTo(map);
                        ...
                        var popup = new tt.Popup({offset: popupOffsets}).setHTML("<b>Universitas Sanata Dharma</b><br/>Jl. Mrican Baru, Mrican, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281");
