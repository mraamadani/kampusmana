    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg" data-aos="fade-left" data-aos-easing="ease-in-sine">
                <img src="<?= base_url();?>assets/img/logo/uii-page.png" alt="Universitas Islam Indonesiaa" class="img-fluid gambar-header-amikom">
            </div>
        </div>
    </div>
</section>
<!-- Akhir Header -->
    ...
    <section class="info" data-aos="fade-right" data-aos-easing="ease-out-in">
        ...
        <h3>Info</h3>
            <div class="row">
                <div class="col">
                    <p>Jika tertarik dengan kampus Universitas Islam Indonesia, info lebih lanjut klik <a href="http://www.uii.ac.id" target="_blank">di sini</a>.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <center><div id='map'></div></center>
                    <script>
                        ...
                        var marker = new tt.Marker().setLngLat(uii).addTo(map);
                        ...
                        var popup = new tt.Popup({offset: popupOffsets}).setHTML("<b>Universitas Islam Indonesia</b><br/>Jl. Ngringin, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55283");
