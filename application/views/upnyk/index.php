    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg" data-aos="fade-left" data-aos-easing="ease-in-sine">
                <img src="<?= base_url();?>assets/img/logo/upnyk-page.png" alt="UPN Veteran Yogyakarta" class="img-fluid gambar-header-amikom">
            </div>
        </div>
    </div>
</section>
<!-- Akhir Header -->
    ...
    <section class="info" data-aos="fade-right" data-aos-easing="ease-out-in">
        ...
        <h3>Info</h3>
            <div class="row">
                <div class="col">
                    <p>Jika tertarik dengan kampus UPN Veteran Yogyakarta, info lebih lanjut klik <a href="http://www.uii.ac.id" target="_blank">di sini</a>.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <center><div id='map'></div></center>
                    <script>
                        ...
                        var marker = new tt.Marker().setLngLat(upnyk).addTo(map);
                        ...
                        var popup = new tt.Popup({offset: popupOffsets}).setHTML("<b>UPN Veteran Yogyakarta</b><br/>Jl. Ring Road Utara, Ngropoh, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281");
